...
struct DetailTodoItemView: View {
    ...
    // TODO: -
    // - [ ] На экране добавления или редактирования дела добавить возможность менять категорию дела в виде списка всех доступных вариантов.
    // - [ ] Реализовать возможность добавлять новую категорию в настройках. Форма для добавления на свое усмотрение.
